...
INSERT INTO md_expense_sub_item (scenario_id, exp_code, sub_code, sub_name, spec, unit, quantity, unit_price, amount, remark, sort_order)
VALUES
('default', 'FIX_WEL_CHECKUP', 'CHECKUP_01', '건강검진비', '', '회/월', 0.0833, 340000, 28322, '1회/년÷12개월', 1);
...
INSERT INTO md_expense_sub_item (scenario_id, exp_code, sub_code, sub_name, spec, unit, quantity, unit_price, amount, remark, sort_order)
VALUES
('default', 'FIX_WEL_MEDICINE', 'MED_01', '의약품비', '', 'SET/월', 0.0033, 145000, 478, '1SET/년÷12개월÷25인', 1);
